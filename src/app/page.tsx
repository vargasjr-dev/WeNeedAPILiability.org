        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-6 text-sm">
              <Link href="/proposal" className="text-slate-300 hover:text-white transition-colors">
                Proposal
              </Link>
              <Link href="/scenarios" className="text-slate-300 hover:text-white transition-colors">
                Scenarios
              </Link>
              <Link href="/roadmap" className="text-slate-300 hover:text-white transition-colors">
                Roadmap
              </Link>
              ...
              <div className="relative">
                <div className="w-72 h-96 bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg shadow-2xl transform rotate-3 flex items-center justify-center border border-slate-600">
                  <div className="text-center p-8">
                    ...
                    <h3 className="text-white font-semibold text-lg mb-2">API Liability Framework</h3>
                    <p className="text-slate-400 text-sm">A policy proposal for human accountability in autonomous systems</p>
                  </div>
                </div>
